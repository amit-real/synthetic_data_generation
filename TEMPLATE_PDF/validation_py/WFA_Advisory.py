...
class WFA_Advisory_Page1(BaseDoc):
    address: str = Field(None, description="address", error_message="address is missing")
...
class DocumentModel(BaseModel):
    page_1: WFA_Advisory_Page1


PAGE_SCHEMA_MAPPING = {1: WFA_Advisory_Page1}
